...
<head>
    ...
    <style>
        ...
        .login-container {
            ...
            background: white;
            border-radius: 8px;
            box-shadow: 0 4px 10px rgba(113, 199, 64, 0.1);
        }
        ...
        .input {
            padding: 10px;
            margin-bottom: 15px;
            border: 1px solid #48c528ff;
            border-radius: 4px;
            font-size: 16px;
        }

        .input:focus {
            border-color: #83d14fff;
            outline: none;
        }

        .btn {
            padding: 10px;
            background-color: #6dd14fff;
            border: none;
            border-radius: 4px;
            color: white;
            font-size: 16px;
