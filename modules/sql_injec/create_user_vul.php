...
<head>
  ...
  <style>
    :root {
      ...
      --danger: #ff6b6b;
      --radius: 10px;
      --shadow: 0 10px 30px rgba(110, 173, 27, 0.6);
      font-family: "Inter", Arial, sans-serif;
    }
    html,body{height:100%;margin:0}
    body {
      background: linear-gradient(180deg,#061021 0%, #37b318ff 60%);
      color: var(--text);
      display:flex;
    ...
    .container {
      ...
      max-width: 480px;
      padding: 28px 26px;
      border: 1px solid rgba(70, 190, 14, 0.05);
    }
    .back {
      display:inline-flex;
      align-items:center;
    ...
    input[type="text"], input[type="password"] {
      ...
      padding:10px 12px;
      border-radius:8px;
      border:1px solid rgba(55, 199, 36, 0.08);
      background: rgba(87, 194, 25, 0.03);
      color:var(--text);
      margin-bottom:14px;
      font-size:14px;
    }
    input:focus {
      ...
      background: rgba(122, 216, 45, 0.06);
    }
    ...
    .message {
      background: rgba(95, 202, 33, 0.03);
      border-left:4px solid #a3d37bff;
      padding:10px 12px;
      border-radius:8px;
      color:#b7f0d0;
      margin-bottom:14px;
